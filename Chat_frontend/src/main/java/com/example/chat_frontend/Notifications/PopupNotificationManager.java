...
@Setter
public class PopupNotificationManager extends NotificationHandler {

    private static final String FXML_PATH = "/com/example/chat_frontend/NotificationPopup.fxml";
